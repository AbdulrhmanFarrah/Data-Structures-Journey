/*
	This Program is for studying the section 1 in chapter 2 for (data structures and other objects using c++) book.
	This section talks about Basic OOP Concepts using throttle class example and this program is the implementaion of the throttle class.
*/
